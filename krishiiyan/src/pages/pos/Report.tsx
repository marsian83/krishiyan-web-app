    ...
    <div>
      ...
      <section className='grid grid-rows-[10%_28%_60%] h-[88vh]'>
        <div className='w-full flex items-center gap-x-[2%] pl-[24%]'>
          <button className='text-[#F3FFF1] bg-[#526D4E] rounded-md px-[2%] h-[5vh] '>Day</button>
          <button className='text-[#F3FFF1] bg-[#05AB2A] rounded-md px-[2%] h-[5vh] '>Week</button>
          <button className='text-[#F3FFF1] bg-[rgb(5,171,42)] rounded-md px-[2%] h-[5vh] '>Month</button>
          <button className='text-[#F3FFF1] bg-[#05AB2A] rounded-md px-[2%] h-[5vh] '>Year</button>
        </div>
