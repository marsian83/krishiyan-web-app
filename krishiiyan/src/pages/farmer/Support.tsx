        ...
        <div className="my-10 flex justify-between w-[55%] ml-[6%]">
          <button
            ...
            className={` text-[#F3FFF1] shadow-[0px_4px_3px_rgba(0,0,0,0.25)] w-[10vw] py-1 px-3 rounded text-sm font-thin ${
              openTab === "Crop Health" ? "bg-[#05AB2A]" : "bg-[#526D4E]"
            }`}
            onClick={() => {
              setOpenTab("Crop Health");
            }}
          >
            Crop Health
          </button>
          <button
            type="submit"
            className={` text-[#F3FFF1] shadow-[0px_4px_3px_rgba(0,0,0,0.25)] w-[10vw] py-1 px-3 rounded text-sm font-thin ${
              openTab === "Soil Testing" ? "bg-[#05AB2A]" : "bg-[#526D4E]"
            }`}
            onClick={() => {
              setOpenTab("Soil Testing");
            }}
          >
            Soil Testing
          </button>
          <button
            type="submit"
            className={` text-[#F3FFF1] shadow-[0px_4px_3px_rgba(0,0,0,0.25)] w-[10vw] py-1 px-3 rounded text-sm font-thin ${
              openTab === "Credit" ? "bg-[#05AB2A]" : "bg-[#526D4E]"
            }`}
            onClick={() => {
              setOpenTab("Credit");
            }}
          ...
          <button
            type="submit"
            className={` text-[#F3FFF1] shadow-[0px_4px_3px_rgba(0,0,0,0.25)] w-[10vw] py-1 px-3 rounded text-sm font-thin ${
              openTab === "Query" ? "bg-[#05AB2A]" : "bg-[#526D4E]"
            }`}
            onClick={() => {
              setOpenTab("Query");
            }}
          ...
          <div className="grid grid-cols-[53%_47%] mt-4">
            <div className="grid grid-cols-[47%_53%] text-center my-6">
              ...
              <textarea
                cols={col}
                rows={row}
                className="bg-[#F3FFF1]  shadow-[4px_4px_4px_rgba(0,0,0,0.25)] rounded-md"
              />
            </div>
            <div className="flex flex-col items-center mt-6">
              <div>
                <label className="text-[#13490A] flex-[1] text-center font-roboto font-extrabold text-sm mx-5">
                  Laboratory
                </label>
                <input
                  type="text"
                  className="bg-[#F3FFF1] flex-[2] h-8 w-35 shadow-[4px_4px_4px_rgba(0,0,0,0.25)] rounded-md"
                />
              </div>
              <div>
                <button
                  type="submit"
                  className="bg-[#526D4E] text-[#F3FFF1] shadow-[0px_4px_3px_rgba(0,0,0,0.25)] ml-28 mt-10 w-[12vw] 
                 h-16 rounded text-sm font-thin"
                >
                  Download Report
                </button>
              </div>
