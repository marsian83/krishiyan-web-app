...
const PestManagement = () => {
  return (
    <section className="p-2">
      <table className="border border-black border-collapse h-[60vh] w-[80%]">
        <tr className="text-[#13490A] font-bold text-base text-center">
          ...
          <th className="border border-black border-collapse">Caused by</th>
          <th className="border border-black border-collapse">
            Characteristic of the pest
          </th>
          <th className="border border-black border-collapse">
            Notable symptoms at stage
          </th>
          <th className="border border-black border-collapse">Image</th>
          <th className="border border-black border-collapse">Solution</th>
          <th className="border border-black border-collapse">
      ...
      <br />
      <div style={{ fontSize: "25px", textAlign: "start" }}>
        {" "}
        Deficieny Symptons
      </div>
      <table className="border border-black border-collapse h-[60vh] w-[60%]">
        <tr className="text-[#13490A] font-bold text-base text-center">
          ...
          <th className="border border-black border-collapse">Solution</th>
          <th className="border border-black border-collapse">
            Reccomendation (or) <br /> Method of tpplication <br /> (Including
            Dosage ){" "}
          </th>
        </tr>
