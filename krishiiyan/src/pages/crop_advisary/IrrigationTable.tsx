    ...
    <section className="p-2">
      <table className="border border-black border-collapse h-[60vh] w-[60%]">
        <tr className="text-[#13490A] font-bold text-base text-center">
          ...
          <th className="border border-black border-collapse">Days</th>
          <th className="border border-black border-collapse">Soil</th>
          <th className="border border-black border-collapse">Season</th>
          <th className="border border-black border-collapse">
            Irrigation Method
          </th>
        </tr>
