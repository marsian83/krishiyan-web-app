...
const HerbicideCal = (props: any) => {
  ...
  if (!show) return <></>;
  const Product = props.allHerbicides.find(
    (herbicide: any) => herbicide._id === props.product
  );
  const Problem = props.allWeed.find((weed: any) => weed._id === props.problem);
  return (
    <>
