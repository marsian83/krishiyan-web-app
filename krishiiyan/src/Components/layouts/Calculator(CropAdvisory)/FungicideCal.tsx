...
const FungicideCal = (props: any) => {
  ...
  if (!show) return <></>;
  const Product = props.allFungicide.find(
    (fungicide: any) => fungicide._id === props.product
  );
  const Problem = props.allDisease.find(
    (disease: any) => disease._id === props.problem
  );
  return (
    <>
