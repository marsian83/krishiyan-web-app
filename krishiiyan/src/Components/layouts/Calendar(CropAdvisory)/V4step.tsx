...
const V4step = (props: any) => {
  return (
    <>
      ...
      >
        <div>
          <p>Description: {props?.cropDetails?.cultivationStage?.V4?.description}</p>
          <p>NutrientContains: </p>
          <br />
          <p>Nitrogen: {props?.cropDetails?.cultivationStage?.basal?.nutrientContains?.n}
          </p>
          <p>Phosphorus: {props?.cropDetails?.cultivationStage?.basal?.nutrientContains?.p}
          </p>
          <p>Potassium: {props?.cropDetails?.cultivationStage?.basal?.nutrientContains?.k}
          </p>
          <p>Zinc: {props?.cropDetails?.cultivationStage?.basal?.nutrientContains?.Zn}
          </p>
          <p>
          ...
          <p>
            InterculturalOperation: {props?.cropDetails?.cultivationStage?.basal
