...
import CropLibrary from "./pages/crop_advisory_admin/CropLiberaryAdmin";
import CropCalendar from "./pages/crop_advisory_admin/CropCalanderAdmin";
import CropHealth from "./pages/crop_advisory_admin/CropHealthAdmin";
...
function AdminPanel() {
  return (
    <div className="AdminPanel font-roboto box-border m-0 p-0">
      <Routes>
